...
var $author$project$Main$JsonToYaml = {$: 'JsonToYaml'};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{dark: true, direction: $author$project$Main$JsonToYaml, errorMsg: $elm$core$Maybe$Nothing, jsonInput: '{\n  \"hello\": \"world\"\n}', output: '', yamlInput: 'hello: world\n'},
		$elm$core$Platform$Cmd$none);
};
var $author$project$Main$GotError = function (a) {
	return {$: 'GotError', a: a};
};
var $author$project$Main$GotJsonToYaml = function (a) {
	return {$: 'GotJsonToYaml', a: a};
};
var $author$project$Main$GotYamlToJson = function (a) {
	return {$: 'GotYamlToJson', a: a};
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$onError = _Platform_incomingPort('onError', $elm$json$Json$Decode$string);
var $author$project$Main$onJsonToYaml = _Platform_incomingPort('onJsonToYaml', $elm$json$Json$Decode$string);
var $author$project$Main$onYamlToJson = _Platform_incomingPort('onYamlToJson', $elm$json$Json$Decode$string);
var $author$project$Main$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Main$onJsonToYaml($author$project$Main$GotJsonToYaml),
				$author$project$Main$onYamlToJson($author$project$Main$GotYamlToJson),
				$author$project$Main$onError($author$project$Main$GotError)
			]));
};
var $author$project$Main$YamlToJson = {$: 'YamlToJson'};
var $elm$json$Json$Encode$string = _Json_wrap;
var $author$project$Main$copyToClipboard = _Platform_outgoingPort('copyToClipboard', $elm$json$Json$Encode$string);
var $author$project$Main$jsonToYaml = _Platform_outgoingPort('jsonToYaml', $elm$json$Json$Encode$string);
var $elm$core$Basics$not = _Basics_not;
var $author$project$Main$yamlToJson = _Platform_outgoingPort('yamlToJson', $elm$json$Json$Encode$string);
					...
					_Utils_update(
						model,
						{
							direction: function () {
								...
								if (_v1.$ === 'JsonToYaml') {
									return $author$project$Main$YamlToJson;
								} else {
									return $author$project$Main$JsonToYaml;
								}
							}(),
			...
			case 'DoConvert':
				...
				if (_v2.$ === 'JsonToYaml') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{errorMsg: $elm$core$Maybe$Nothing, output: ''}),
						$author$project$Main$jsonToYaml(model.jsonInput));
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{errorMsg: $elm$core$Maybe$Nothing, output: ''}),
						$author$project$Main$yamlToJson(model.yamlInput));
				}
			case 'GotJsonToYaml':
				var s = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{errorMsg: $elm$core$Maybe$Nothing, output: s}),
					$elm$core$Platform$Cmd$none);
			case 'GotYamlToJson':
				var s = msg.a;
				return _Utils_Tuple2(
			...
			case 'GotError':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							errorMsg: $elm$core$Maybe$Just(e),
							output: ''
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					model,
					$author$project$Main$copyToClipboard(model.output));
		}
	});
...
var $author$project$Main$CopyOutput = {$: 'CopyOutput'};
var $author$project$Main$DoConvert = {$: 'DoConvert'};
var $author$project$Main$UpdateJson = function (a) {
	return {$: 'UpdateJson', a: a};
};
var $author$project$Main$UpdateYaml = function (a) {
	return {$: 'UpdateYaml', a: a};
};
...
var $author$project$Main$onDark = F2(
	function (model, c) {
		return model.dark ? c : c;
	});
...
var $author$project$Main$panel = F5(
	function (model, title, toMsg, value, isEditable) {
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
						$author$project$Main$onDark,
						model,
						A4($mdgriffith$elm_ui$Element$rgba, 0.96, 0.965, 0.98, 0.1))),
			...
			_List_fromArray(
				[
					...
					isEditable ? A2(
						...
						_List_fromArray(
							[
								...
								A2(
									$author$project$Main$onDark,
									model,
									A4($mdgriffith$elm_ui$Element$rgba, 1, 1, 1, 0.06))),
						...
						{
							label: $mdgriffith$elm_ui$Element$Input$labelHidden(title),
							onChange: A2(
								$elm$core$Maybe$withDefault,
								function (_v0) {
									return _Debug_todo(
...
var $author$project$Main$primaryButton = F3(
	function (model, label_, msg_) {
		return A2(
			$mdgriffith$elm_ui$Element$Input$button,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Border$rounded(12),
					A2($mdgriffith$elm_ui$Element$paddingXY, 16, 10),
					$mdgriffith$elm_ui$Element$Background$gradient(
					{
						angle: $elm$core$Basics$pi / 12,
						steps: _List_fromArray(
							[
								A4($mdgriffith$elm_ui$Element$rgba, 0.47, 0.51, 1.0, 0.9),
								A4($mdgriffith$elm_ui$Element$rgba, 0.63, 0.71, 1.0, 0.9)
							])
					}),
			...
			{
				label: $mdgriffith$elm_ui$Element$text(label_),
				onPress: $elm$core$Maybe$Just(msg_)
			});
	});
var $author$project$Main$secondaryButton = F3(
	function (model, label_, msg_) {
		return A2(
			$mdgriffith$elm_ui$Element$Input$button,
			_List_fromArray(
				[
					...
					A2(
						$author$project$Main$onDark,
						model,
						A4($mdgriffith$elm_ui$Element$rgba, 0.9, 0.92, 1.0, 0.2)))
				]),
			{
				label: $mdgriffith$elm_ui$Element$text(label_),
				onPress: $elm$core$Maybe$Just(msg_)
...
var $author$project$Main$converterArea = function (model) {
	var rightTitle = function () {
		var _v2 = model.direction;
		if (_v2.$ === 'JsonToYaml') {
			return 'YAML Output';
		} else {
	...
	var leftInfo = function () {
		var _v1 = model.direction;
		if (_v1.$ === 'JsonToYaml') {
			return {title: 'JSON Input', update: $author$project$Main$UpdateJson, value: model.jsonInput};
		} else {
			return {title: 'YAML Input', update: $author$project$Main$UpdateYaml, value: model.yamlInput};
		}
	}();
	return A2(
		$mdgriffith$elm_ui$Element$column,
			...
			[
				...
				_List_fromArray(
					[
						...
						model,
						leftInfo.title,
						$elm$core$Maybe$Just(leftInfo.update),
						leftInfo.value,
						true),
						A5($author$project$Main$panel, model, rightTitle, $elm$core$Maybe$Nothing, model.output, false)
					])),
				A2(
				$mdgriffith$elm_ui$Element$row,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A3($author$project$Main$primaryButton, model, 'Convert', $author$project$Main$DoConvert),
						A3($author$project$Main$secondaryButton, model, 'Copy result', $author$project$Main$CopyOutput)
					])),
				function () {
				...
				if (_v0.$ === 'Nothing') {
					...
					return A2(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$Font$color(
								A3($mdgriffith$elm_ui$Element$rgb255, 255, 120, 120)),
								$mdgriffith$elm_ui$Element$Background$color(
								A2(
									$author$project$Main$onDark,
									model,
									A4($mdgriffith$elm_ui$Element$rgba, 1.0, 0.9, 0.9, 0.15))),
								$mdgriffith$elm_ui$Element$Border$rounded(12),
								$mdgriffith$elm_ui$Element$padding(12)
							]),
...
var $author$project$Main$ToggleDirection = {$: 'ToggleDirection'};
var $author$project$Main$ToggleTheme = {$: 'ToggleTheme'};
var $author$project$Main$headerBar = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$text('jy-converter')),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Font$color(
						A3($mdgriffith$elm_ui$Element$rgb255, 130, 130, 255))
					]),
				$mdgriffith$elm_ui$Element$text(' • JSON ↔ YAML')),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						A2(
							$author$project$Main$onDark,
							model,
							A4($mdgriffith$elm_ui$Element$rgba, 0.9, 0.92, 0.96, 0.4)))
					]),
				{
					label: $mdgriffith$elm_ui$Element$text(
						function () {
							...
							if (_v0.$ === 'JsonToYaml') {
								...
								return 'Mode: YAML → JSON';
							}
						}()),
					onPress: $elm$core$Maybe$Just($author$project$Main$ToggleDirection)
				}),
				A2(
				$mdgriffith$elm_ui$Element$Input$button,
				_List_fromArray(
				...
				{
					label: $mdgriffith$elm_ui$Element$text(
						model.dark ? 'Theme: Dark' : 'Theme: Light'),
...
var $author$project$Main$themeBody = function (dark) {
	return _List_fromArray(
		[
			$mdgriffith$elm_ui$Element$Background$color(
			dark ? A3($mdgriffith$elm_ui$Element$rgb255, 18, 20, 26) : A3($mdgriffith$elm_ui$Element$rgb255, 250, 251, 253)),
			$mdgriffith$elm_ui$Element$Font$color(
			dark ? A3($mdgriffith$elm_ui$Element$rgb255, 235, 238, 245) : A3($mdgriffith$elm_ui$Element$rgb255, 35, 38, 46)),
			$mdgriffith$elm_ui$Element$Font$family(
			_List_fromArray(
				[
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		$author$project$Main$themeBody(model.dark),
		A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					$author$project$Main$headerBar(model),
					$author$project$Main$converterArea(model)
				])));
};
